export const CURRENCIES = [
  { symbol: 'BTC', icon: '/images/home/selecta/btc-icon.svg' },
  { symbol: 'ETH', icon: '/images/home/selecta/eth-icon.svg' },
  { symbol: 'AUD', icon: '/images/home/selecta/aud-icon.svg' },
  { symbol: 'USD', icon: '/images/home/selecta/usd-icon.svg' },
  { symbol: 'EUR', icon: '/images/home/selecta/eur-icon.svg' },
] as const;
