        ...
        <table role="presentation" style="max-width: 640px; width: 100%; border-collapse: collapse; background-color: #fff; overflow: hidden;">
          <tr>
            <td style="padding: 0; height: 100px;">
              <img style="width: 100%; height: auto;" src="https://selecta.com/images/email-header.png" alt="Travellio Global Logo">
            </td>
          </tr>
          <tr>
            <td style="padding: 32px; background: #fff;">
              ...
              <p style="margin: 0 0 24px; color: #333;font-size: 16px;font-style: normal;font-weight: 400;line-height: 140%;">
                In the meantime, feel free to explore our latest insights at <a href="https://selecta.com" style="color: #333;font-weight: 700;text-decoration: underline;" target="_blank">selecta.com</a>.
              </p style="margin: 0 0 24px; color: #333;font-size: 16px;font-style: normal;font-weight: 400;line-height: 140%;">
              <p style="margin: 0 0 24px; color: #333;font-size: 16px;font-style: normal;font-weight: 400;line-height: 140%;">
                Best regards,<br>
          ...
          <tr>
            <td style="padding: 0; height: 100px;">
              <img style="width: 100%; height: auto;" src="https://selecta.com/images/email-footer.png" alt="Travellio Global Logo">
            </td>
          </tr>
        </table>
      </td>
